...
characteristic_UUID = [ "00002a40-0000-1000-8000-00805f9b34fb", "00002a41-0000-1000-8000-00805f9b34fb", "00002a42-0000-1000-8000-00805f9b34fb",  "00002a43-0000-1000-8000-00805f9b34fb"]#UUID of each characteristic
nb_char = len(characteristic_UUID)

values = [ [] for i in range(nb_char)]
timestamps = [ [] for i in range(nb_char)]
handles = {}
running = True
recording = False
files = [open("datax.csv", "a"), open("datay.csv", "a"), open("dataz.csv", "a"), open("datae.csv", "a")]
...
plotcols = ["black","red", "blue", "green"]
lines = []
for index in range(nb_char):
